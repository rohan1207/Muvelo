...
const DynamicCarousel3_4 = ({ theme = 'dark' }) => {
  ...
  return (
    <>
      {/* Add style tag for 3:4 aspect ratio on mobile (phone screens only) */}
      <style>{`
        @media (max-width: 640px) {
          .dynamic-carousel-mobile-3-4 {
            height: auto !important;
            aspect-ratio: 3/4 !important; /* Strict 3:4 ratio - width:height = 3:4 */
            /* Height will be automatically calculated as width * (4/3) = 133.33vw */
          }
        }
      ...
      <motion.div
        className="absolute left-[27%] sm:left-[32%] md:left-[34%] z-17 -translate-x-1/2 pointer-events-none bottom-[18vh] sm:bottom-[12vh]"
        style={{
      ...
      <motion.div
        className="absolute left-[34%] sm:left-[34%] md:left-[35%] z-20 -translate-x-1/2 bottom-[14vh] sm:bottom-[20vh]"
        style={{
          x: imageX,               // locked to table horizontal motion
          opacity: lampOpacity,
          y: lampY,
...
export default DynamicCarousel3_4;
